...
class ListElementModel extends BaseModel<ListElement> {
  ...
  @override
  ListElement toEntity() =>
      ListElement(dtTxt: this.dtTxt, main: this.main.toEntity(), wind: this.wind.toEntity(), weather: this.weather.map((w) => w.toEntity()).toList());
}
...
class MainClassModel extends BaseModel<MainClass> {
  ...
  factory MainClassModel.fromJson(Map<String, dynamic> json) => MainClassModel(
        temp: json["temp"] == null ? null : json["temp"].toString(),
  ...
  MainClass toEntity() => MainClass(
        ...
        temp: (double.tryParse(this.temp)-273.15).toInt().toString(),
        tempKf: this.tempKf,
